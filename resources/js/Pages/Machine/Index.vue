                    ...
                    <Builder v-if="render" :url="route('master-machines.paginate')" ref="table">
                        <template #thead="table">
                            <tr class="bg-gray-200 border-gray-300">
                                ...
                                <Th :table="table" :sort="true" name="code"
                                ...
                                <Th :table="table" :sort="true" name="location"
                                    class="border px-3 py-2 text-center whitespace-nowrap capitalize font-bold">
                                    {{ __('location') }}
                                </Th>                        
                          ...
                          >
                            ...
                            <template v-else>
                              ...
                              >
                                ...
                                <td class="capitalize font-semibold text-center border-b">
                                  <span
                                    :class="machine.status === 'aktif' ? 'text-green-600' : 'text-red-600'"
                                  >
                                    {{ machine.status }}
                                  </span>
                                </td>
                            ...
                            <template v-if="hasRole(['superuser', 'user', 'asman', 'spv', 'ampr', 'mpm', 'it']) && !regis">
                                <div class="flex flex-col space-y-2">
                                  <div class="flex items-center space-x-2">
                                      <label for="code" class="w-1/3 capitalize">
                                          {{ __('code') }}
                                      </label>

                                      <Input v-model="form.code"
                                          :placeholder="__('code')" type="text"
                                          required />
                                  </div>
                                ...
                                <div class="flex flex-col space-y-2">
                                    <div class="flex items-center space-x-2">
                                        <label for="location" class="w-1/3 capitalize">
                                            {{ __('location') }}
                                        </label>

                                        <Input v-model="form.location"
                                            :placeholder="__('location')" type="text"
                                            required />
                                    </div>

                                    <InputError :error="form.errors.location" />
                                </div>
